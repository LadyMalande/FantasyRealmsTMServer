...
public class DeckInitializer implements Serializable{
    void storeDecktoFile() {
        ...
        tempDeck.add(new Card(34,"Water Elemental",4, Type.FLOOD, new ArrayList<>() {{add(new PlusForEachSelftypeExceptThis(15,34,Type.FLOOD));}}, null, null));
        ...
        tempDeck.add(new Card(37,"Fire Elemental",4, Type.FIRE, new ArrayList<>() {{add(new PlusForEachSelftypeExceptThis(15,37,Type.FIRE));}}, null, null));
        ...
        tempDeck.add(new Card(41,"Wildfire",40, Type.FIRE, null, new ArrayList<>() {{add(new DeletesAllExceptTypeOrCard(new ArrayList<>() {{add(Type.FIRE);add(Type.WIZARD);add(Type.WEATHER);add(Type.WEAPON);add(Type.ARTIFACT);}},new ArrayList<>() {{add(45);add(33);add(1);add(36);add(5);}},41));}}, null));
        ...
        tempDeck.add(new Card(43,"Earth Elemental",4, Type.EARTH, new ArrayList<>() {{add(new PlusForEachSelftypeExceptThis(15,43,Type.EARTH));}}, null, null));
        tempDeck.add(new Card(44,"Cave",6, Type.EARTH, new ArrayList<>() {{add(new PlusIfYouHaveAtLeastOneCard(25,new ArrayList<>() {{add(5);add(24);}}));add(new DeleteAllMalusesOnType(Type.WEATHER));}}, null, null));
        ...
        tempDeck.add(new Card(48,"Air Elemental",4, Type.WEATHER, new ArrayList<>() {{add(new PlusForEachSelftypeExceptThis(15,48,Type.WEATHER));}}, null, null));
