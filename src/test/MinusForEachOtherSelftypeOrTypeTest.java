...
class MinusForEachOtherSelftypeOrTypeTest {
    ...
    void initHand(){
        ...
        cardToBeTested = deck.stream().filter(card -> card.getNameLoc("cs").equals("Trpasličí pěchota")).findAny().get();
    ...
    void countConditionSatisfied() {
        ...
        assertEquals(malus.count(cardsInHands), -2);
    }
    ...
    void countConditionSatisfied2() {
        ...
        assertEquals(malus.count(cardsInHands), -4);
    }
